            ...
            <Container className='my-3'>
                <Card style={{ width: '70rem' }}>
                    ...
                    <ListGroup className="list-group-flush">
                        ...
                        <ListGroupItem><h5>৭। ত্রৈমাসিক আত্মোন্নয়ন কোর্স- এতে সায়েন্টিফিক লেকচার ও মেডিটেশনের মাধ্যমে অভিযাত্রীগণের শারীরিক ও মানসিক প্রশান্তিসহ আত্মশুদ্ধির উন্নতি করা হয়।</h5></ListGroupItem>
                        <ListGroupItem><h5>৮। শিক্ষার্থীদের উদ্যোগে ত্রৈমাসিক দেয়ালিকা প্রকাশ।</h5></ListGroupItem>
                        <ListGroupItem><h5>৯। প্রতি শুক্রবার সকাল ১১:০০টায় শিক্ষার্থীদের শরীরচর্চা, ১১:৩০টায় নৈতিক শিক্ষা, দুপুর ১২:৩০টায় ফুড ফর লাইফ এবং বিকেল ৪:০০টায় মেডিটেশন ও কাউন্সেলিং।</h5></ListGroupItem>
                    </ListGroup>
                </Card>
            </Container>
            <Container className=' my-4'>
                ...
                <Card style={{ width: '70rem' }}>
                    ...
                    <ListGroup className="list-group-flush">
                        ...
                        <ListGroupItem><h5>২। মহান মুক্তিযদ্ধের চেতনা এবং গণপ্রজাতন্ত্রী বাংলাদেশ সংবিধানের প্রতি সংগঠন ও এর সদস্যবৃন্দ শ্রদ্ধাশীল। সংগঠনের সকল কর্মকান্ড সংবিধান সম্মত ও মুক্তিযুদ্ধের আদর্শে উজ্জীবিত।</h5></ListGroupItem>
