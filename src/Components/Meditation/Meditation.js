    ...
    return (
        <div className='container my-4'>
            <div className='text-success'>
                <h2 className='text-center bg-primary text-white p-3'>আত্মোন্নয়ন কোর্সে অংশ নিন জীবনে পরিপূর্ণতা আনুন </h2>
                <h2 className='text-center text-danger'>সায়েন্টিফিক লেকচার ও মেডিটেশন </h2>
            </div>
            <div className='text-dark my-2'>
                <h4 className='text-justify lh-base'>মানুষের দুটি সত্তা আছে, একটা হচ্ছে পশুত্ব অন্যটি মনুষ্যত্ব। মানুষ মনুষ্যত্ব নিয়ে জন্মগ্রহণ করে না। কঠোর সাধনা আর আত্মোপলব্ধির মাধ্যমে মানুষকে মনুষ্যত্ব অর্জন করতে হয়।
            ...
            <div className='container text-center my-4'>
                <h2 className='text-center bg-primary text-white p-3'> আমাদের ইউটিউব চ্যানেল</h2>
                <div className='p-4'>
                    <Media />
                </div>
            </div>
            <div className='my-4'>
                <Card className="text-center">
                    <Card.Header className='text-center bg-primary text-white p-3 '><h2>সাপ্তাহিক মেডিটেশন</h2></Card.Header>
                    <Card.Body>
                        <Card.Title><h3>প্রতি শুক্রবার সকাল ৮:০০ টায় </h3></Card.Title>
                        <Card.Text>
                            <h2 className='text-danger'>প্রজ্ঞাজ্যোতি হল</h2>
                        </Card.Text>
                        <Card.Text>
            ...
            <div>
                <Card className="text-center">
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            <h2 className='text-danger'>কালচারাল পার্ক মেডিটেশন সেন্টার</h2>
                        </Card.Text>
                        <Card.Text>
            ...
            <div>
                <Card className="text-center">
                    <Card.Header className='text-center bg-primary text-white p-3'><h2>ত্রৈমাসিক তিন দিনের আত্মোন্নয়ন কোর্স</h2></Card.Header>
                    <Card.Body>
                        ...
                        <a className=' text-success text-decoration-none' href='https://forms.gle/VfUbufgY5oGVjaiF7' target='_blank'>
                            <span className='text-primary fs-4 fw-bold lh-sm'>নাম নিবন্ধন করুন</span>
                        </a>
